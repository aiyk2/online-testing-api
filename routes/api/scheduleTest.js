...
// @route   GET api/set-test/test
// @desc    Tests schedule-test route
// @access  Public
router.get("/test", (req, res) => res.json({ msg: "Schedule test Works" }));
...
router.post(
  ...
  (req, res) => {
    const validate = validateScheduleTestInput(req.body);
